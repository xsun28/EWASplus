...
dataset = 'AD_CpG'
file <- paste("/home/ec2-user/CpGPython/data/",dataset,"/all_sites_winid.csv", sep='')
working_dir <- "/home/ec2-user/extra_storage/CpG_EWAS/GenoCanyon/GenoCanyon_10K/"
output_dir <- paste("/home/ec2-user/extra_storage/CpG_EWAS/GenoCanyon/Results/",dataset,"/selected_site_scores.txt",sep='')
