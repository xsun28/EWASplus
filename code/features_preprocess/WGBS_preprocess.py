...
class WGBS_Preprocess():
    def __init__(self,h5s_file= home+'data/WGBS_single_H5S',data_dir = extra_storage+'WGBS/',sites_file = home+'data/all_sites_winid.csv',additional_feature_file = home+'data/features/addtional_features',hg19_file= home+'data/WGBS/hg19_WGBS.csv',chrs=np.arange(1,23,dtype='int64')):
