...
class DANN_Preprocess(object):
    ...
    def __init__(self,data_dir = extra_storage+'DANN/',
        ...
        logger.info('Process DANN features for sites in file {}, to be output to {}'.format(sites_file,additional_feature_file))
    ...
    def process(self):
        ...
        with pd.HDFStore(self.additional_feature_file,'a') as h5s:
            ...
            logger.info('DANN features of sites in {} are outputted to {}'.format(self.sites_file,self.additional_feature_file))
