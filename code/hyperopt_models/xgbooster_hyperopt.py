...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 16:43:28 2018
...
def xgb_loss(params):
    ...
    score = cal_opt_score(xgb_estimator,weight_factor)
...
xgb_param = {'learning_rate':hp.choice('learning_rate',[0.1]),'max_depth': 3+hp.randint('max_depth',15),'n_estimators':500+hp.randint('n_estimators',3000),'reg_lambda': hp.uniform('reg_lambda',1,100),'gamma': hp.uniform('gamma',1,30),'weight_factor':weight_factor}
...
joblib.dump(best_params,model_dir+'xgbooster.pkl')