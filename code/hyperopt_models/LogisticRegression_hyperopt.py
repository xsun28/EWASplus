...
def logistic_loss(params):
    ...
    score = cal_opt_score(l_estimator,weight_factor)
    estimators.extend([l_estimator])      
...
l_param = {'C': hp.uniform('C',0.05,10),'weight_factor':weight_factor}
if class_num <= 2:
...
print(best_params)
joblib.dump(best_params,model_dir+'LogisticRegression.pkl')
