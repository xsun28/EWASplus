        ...
        for name in methods:
            if params is not None:
                if name in params.keys():
                    ...
                    logger.info('Hyperparameters for {method} are: {params}'.format(method=name, params=params[name]))
            else:
                logger.info('No params are provided, using default params for models...')
